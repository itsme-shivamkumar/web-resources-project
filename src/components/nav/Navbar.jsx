...
const Navbar = () => {
  ...
  return (
    <div className={`flex flex-col fixed h-screen ${!show?"bg-[#76118f]":""} py-2 px-4 text-xl w-16 items-center gap-20 z-50 `}
    ...
    >
      ...
      {show&&(
        <motion.div className="w-96 bg-grape-200 bg-opacity-90 h-[101%] absolute -z-10 -top-1 " 
        initial={{x:-200}}
        animate={{x:0}}
        >
